...
class AIEngine:
    ...
    def is_car_related(self, email_content: Dict) -> bool:
        ...
        try:
            ...
            car_keywords = {'car', 'automotive', 'vehicle', 'auto', 'motors', 'toyota', 'honda', 'ford', 'bmw', 'mercedes', 'tesla', 'porsche', 'audi', 'lexus', 'sponsorship car'}
    ...
    def generate_response(self, email_content: Dict) -> Tuple[str, str]:
        ...
        try:
            ...
            return response.choices[0].message.content, image_path
        except Exception as e:
